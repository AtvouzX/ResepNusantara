// src/components/minuman/RecipeDetail.jsx
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-cyan-50">
      <main className="max-w-4xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        {/* Recipe Header */}
        <div className="bg-white/15 backdrop-blur-xl border border-white/25 rounded-3xl overflow-hidden shadow-2xl shadow-green-500/5 mb-8">
          <div className="relative h-64 md:h-96 overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="flex items-center space-x-3 mb-3">
                <span className="text-sm font-semibold text-white bg-green-600/90 px-3 py-1.5 rounded-full">
                  Minuman
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl p-6 shadow-lg shadow-green-500/5">
