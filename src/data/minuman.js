    ...
    "resep": {
        "resep1": {
            ...
            "steps": [
                ...
                "Tuangkan teh ke dalam gelas dengan es batu.",
                "Sajikan dingin."
            ],
        ...
        "resep2": {
            ...
            "steps": [
                ...
                "Aduk hingga rata, sajikan hangat."
            ],
        ...
        "resep3": {
            ...
            "steps": [
                "Kerok daging alpukat dan masukkan ke dalam blender.",
                "Tambahkan susu cair, gula, dan es batu.",
                "Blender hingga halus.",
                "Tuangkan ke dalam gelas, sajikan dingin."
            ],
        ...
        "resep4": {
            ...
            "steps": [
                ...
                "Campur sari jeruk dengan gula dan air.",
                "Aduk rata, tambahkan es batu.",
                "Sajikan dingin."
            ],
        ...
        "resep6": {
            ...
            "steps": [
                "Kocok kopi, gula, dan air panas hingga mengental.",
                "Tuangkan susu cair ke dalam gelas berisi es batu.",
                "Tambahkan krim kopi di atasnya.",
                "Sajikan dingin."
            ],
        ...
        "resep7": {
            ...
            "steps": [
                "Siapkan gelas, masukkan cendol.",
                "Tambahkan santan matang dan gula merah cair.",
        ...
        "resep8": {
            ...
            "steps": [
                ...
                "Tuangkan ke dalam gelas, tambahkan topping sesuai selera.",
                "Sajikan segera."
            ],
        ...
        "resep9": {
            ...
            "steps": [
                ...
                "Tambahkan sirup cocopandan dan es serut.",
        ...
        "resep10": {
            ...
            "steps": [
                "Seduh teh dengan air panas.",
                "Tambahkan gula pasir dan perasan lemon, aduk rata.",
                "Tambahkan es batu jika diinginkan.",
                "Sajikan hangat atau dingin."
            ],
            "image_url": "https://www.nestleprofessional.co.id/sites/default/files/styles/np_article_small/public/2023-11/4%20Kreasi%20Minuman%20dengan%20Bubuk%20Lemon%20Tea.jpg?h=ec041e41&itok=Cr0n2Cgj"
        }
    }
};
